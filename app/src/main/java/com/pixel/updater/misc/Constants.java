...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.pixel.version";
    public static final String PROP_DEVICE = "ro.pixel.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "pixel.updater.allow_downgrading";
